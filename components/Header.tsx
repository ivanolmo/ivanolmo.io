    ...
    <header className='sticky top-0 z-10 flex items-center justify-between max-w-3xl px-6 py-4 mx-auto bg-slate-200 dark:bg-slate-800'>
      <Link href='/'>
        <a className='flex items-center gap-2 w-fit'>
          <div className='w-12 h-12 overflow-hidden border-2 border-blue-800 rounded-full dark:border-blue-400 md:w-16 md:h-16'>
            <Image
          ...
          <span className='text-xl font-bold text-blue-800 md:text-2xl dark:text-blue-400'>
            ivanolmo.io
          </span>
        </a>
      </Link>
